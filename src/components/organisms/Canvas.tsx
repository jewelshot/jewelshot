              ...
              >
                ...
                {originalImage && (
                  <div className="relative flex h-full w-1/2 flex-col items-center justify-center">
                    {/* Original Badge */}
                    <div className="absolute left-4 top-4 z-10 flex items-center gap-2 rounded-lg border border-white/10 bg-black/60 px-3 py-1.5 backdrop-blur-[12px]">
                      <svg
                ...
                <div className="relative flex h-full w-1/2 flex-col items-center justify-center">
                  {/* AI Generated Badge */}
                  <div className="absolute left-4 top-4 z-10 flex items-center gap-2 rounded-lg border border-purple-500/30 bg-gradient-to-r from-purple-500/20 to-pink-500/20 px-3 py-1.5 shadow-[0_0_12px_rgba(168,85,247,0.2)] backdrop-blur-[12px]">
                    <svg
